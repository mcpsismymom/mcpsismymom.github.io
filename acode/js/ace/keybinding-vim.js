...
.ace_dialog input {\
  ...
  function showConfirm(cm, template) {
    var pre = hdom('span', {
      $color: 'red',
      $whiteSpace: 'pre'
    }, template); //ace_patch span instead of pre
  ...
  function makePrompt(prefix, desc) {
    return hdom(document.createDocumentFragment(), hdom('span', {
  ...
  function cloneVimState(state) {
    ...
    Object.keys(state).forEach(function (key) {
      var o = state[key];
      if (Array.isArray(o)) o = o.slice();else if (o && _typeof(o) == "object" && o.constructor != Object) o = cloneVimState(o);
      n[key] = o;
    });
