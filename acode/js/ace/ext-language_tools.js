...
define('ace/autocomplete', ['require', 'exports', 'module', 'ace/keyboard/hash_handler', 'ace/autocomplete/popup', 'ace/autocomplete/util', 'ace/lib/lang', 'ace/lib/dom', 'ace/snippets', 'ace/config'], function (require, exports, module) {
  ...
  var Autocomplete = function Autocomplete() {
    ...
    }.bind(this)); // this.tooltipTimer = lang.delayedCall(this.updateDocTooltip.bind(this), 50);
  };
  ...
  (function () {
    this.$init = function () {
      ...
      this.popup.focus = this.editor.focus.bind(this.editor); // this.popup.on('show', this.tooltipTimer.bind(null, null));
