...
define("ace/lib/lang", [], function (require, exports, module) {
  ...
  exports.copyArray = function (array) {
    ...
    for (var i = 0, l = array.length; i < l; i++) {
      if (array[i] && _typeof2(array[i]) == "object") copy[i] = this.copyObject(array[i]);else copy[i] = array[i];
    }
  ...
  exports.deepCopy = function deepCopy(obj) {
    if (_typeof2(obj) !== "object" || !obj) return obj;
    var copy;
...
define("ace/mode/coffee/coffee", [], function (require, exports, module) {
  ...
  function _possibleConstructorReturn(e, a) {
    ...
    return a && ("object" == _typeof2(a) || "function" == typeof a) ? a : e;
  }

  function _inherits(e, a) {
    if ("function" != typeof a && null !== a) throw new TypeError("Super expression must either be null or a function, not " + _typeof2(a));
