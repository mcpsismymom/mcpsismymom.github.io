...
define('ace/mode/javascript_highlight_rules', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/doc_comment_highlight_rules', 'ace/mode/text_highlight_rules'], function (require, exports, module) {
  ...
  var JavaScriptHighlightRules = function JavaScriptHighlightRules(options) {
    var keywordMapper = this.createKeywordMapper({
      ...
      'SyntaxError|TypeError|URIError|' + 'console|decodeURI|decodeURIComponent|encodeURI|encodeURIComponent|eval|isFinite|' + // Non-constructor functions
    ...
    this.$rules = {
      no_regex: [DocCommentHighlightRules.getStartRule('doc-start'), comments('no_regex'), {
        ...
        token: ['variable.language', 'punctuation.operator', 'support.function.firebug'],
        regex: /(console)(\.)(assert|clear|count|countReset|debug|dir|dirxml|error|group|groupCollapsed|groupEnd|info|log|table|time|timeEnd|timeLog|trace|warn)\b/
      }, {
        token: keywordMapper,
        regex: identifierRe
      }, {
