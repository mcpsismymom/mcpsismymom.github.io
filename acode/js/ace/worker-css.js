            ...
            prop,
              ...
              _property: function _property() {
                ...
                if (tokenStream.match(Tokens.IDENT)) {
                  ...
                  this._readWhitespace();
                } else if (tokenStream.peek() === Tokens.RBRACE) {} else {
        ...
        21: [function (require, module, exports) {
          ...
          copy(ValidationTypes, {
            ...
            complex: {
              ...
              "<border-image-slice>": Matcher.many([true
              /* first element is required */
              ], Matcher.cast("<nonnegative-number-or-percentage>"), Matcher.cast("<nonnegative-number-or-percentage>"), Matcher.cast("<nonnegative-number-or-percentage>"), Matcher.cast("<nonnegative-number-or-percentage>"), "fill"),
