...
define("ace/mode/smali_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules"], function (require, exports, module) {
  "use strict";
  ...
  var SmaliHighlightRules = function SmaliHighlightRules() {
    this.$rules = {
      start: [{
        include: "#annotation"
      }, {
        ...
        token: ["text", "constant.language.smali", "text", "variable.parameter.smali", "text", "entity.name.tag.smali", "string.quoted.double.smali", "entity.name.tag.smali"],
        ...
        token: ["text", "constant.language.smali", "text", "entity.name.tag.smali", "string.quoted.double.smali", "entity.name.tag.smali"],
        ...
        token: ["text", "constant.language.smali", "text", "variable.parameter.smali", "variable.parameter.smali", "entity.name.function.smali", "text", "constant.numeric.smali", "text", "constant.numeric.smali", "text", "constant.numeric.smali", "text", "entity.name.tag.smali", "constant.numeric.smali", "entity.name.tag.smali", "text", "constant.numeric.smali"],
        ...
        push: [{
          ...
          token: ["text", "constant.language.smali", "text", "variable.parameter.smali", "text", "string.interpolated.smali", "text", "constant.numeric.smali", "entity.name.tag.smali", "constant.numeric.smali", "entity.name.tag.smali", "text", "entity.name.tag.smali", "string.interpolated.smali", "entity.name.tag.smali", "text", "entity.name.tag.smali", "string.interpolated.smali", "entity.name.tag.smali"],
          regex: /^([\s\t]*)(\.local)([\s\t]+)([vp]\d+)(,[\s\t]+)("[\w_\$][\w\$]*")(:[\[]*)(?:(Z|B|S|C|I|J|F|D)|(L)([\w_\$][\w\d_\$]*(?:\/[\w_\$][\w\d_\$]*)*)(;))(?:(,)(")(.*?)("))?(?:(,[\s\t]*)(")(.*?)("))?(?=[\s\t]*(?:#.*)?$)/,
          comment: "Local"
        }, {
          token: ["text", "constant.language.smali", "text", "entity.name.tag.smali", "constant.numeric.smali", "entity.name.tag.smali", "text", "keyword.control.smali", "text", "keyword.control.smali", "text", "keyword.control.smali"],
          regex: /^([\s\t]*)(\.catch)([\s\t]+)(L)([\w_\$][\w\d_\$]*(?:\/[\w_\$][\w\d_\$]*)*)(;)([\s\t]+{)(:[A-Za-z_\d]+)([\s\t]+\.\.[\s\t]+)(:[A-Za-z_\d]+)(}[\s\t]+)(:[A-Za-z_\d]+)(?=[\s\t]*(?:#.*)?$)/,
          comment: "Catch exceptions"
        }, {
          token: ["text", "constant.language.smali", "text", "keyword.control.smali", "text", "keyword.control.smali", "text", "keyword.control.smali"],
          ...
          push: [{
            ...
            token: ["text", "variable.parameter.smali", "text", "keyword.control.smali"],
            regex: /^([\s\t]*)(-?0x(?:0|[1-9a-f][\da-f]*))([\s\t]+->[\s\t]+)(:[A-Za-z_\d]+)(?=[\s\t]*(?:#.*)?$)/,
            caseInsensitive: true
          }],
          comment: "Sparse Switch"
        }, {
          token: ["text", "constant.language.smali", "text", "variable.parameter.smali"],
      ...
      "#field": [{
        token: ["text", "constant.language.smali", "text", "variable.parameter.smali", "string.interpolated.smali", "text", "constant.numeric.smali", "entity.name.tag.smali", "constant.numeric.smali", "entity.name.tag.smali", "text", "constant.language.smali", "constant.numeric.smali", "constant.numeric.smali", "entity.name.tag.smali", "string.quoted.double.smali", "entity.name.tag.smali"],
      ...
      "#annotation": [{
        token: ["text", "constant.language.smali", "text", "storage.modifier.smali", "text", "entity.name.tag.smali", "constant.numeric.smali", "entity.name.tag.smali"],
      ...
      "#annotation-access": [{
        token: ["text", "support.function.smali", "text", "constant.numeric.smali"],
      ...
      "#annotation-name": [{
        token: ["text", "support.function.smali", "text", "constant.language.smali", "entity.name.tag.smali", "string.quoted.double.smali", "entity.name.tag.smali"],
        regex: /^([\s\t]*)(name)([\s\t]*=[\s\t]*)(?:(null)|(")(.*?)((?:")?))(?=[\s\t]*(?:#.*)?$)/,
        comment: "Name property in annotation"
      }],
      "#annotation-value": [{
        token: ["text", "support.function.smali", "text", "entity.name.tag.smali", "string.quoted.double.smali", "entity.name.tag.smali", "text", "entity.name.tag.smali", "text", "entity.name.tag.smali", "constant.numeric.smali", "entity.name.tag.smali", "text", "string.interpolated.smali", "text", "constant.numeric.smali", "entity.name.tag.smali", "constant.numeric.smali", "entity.name.tag.smali", "entity.name.function.smali", "text", "constant.numeric.smali", "text", "constant.numeric.smali", "text", "constant.numeric.smali", "text", "entity.name.tag.smali", "constant.numeric.smali", "entity.name.tag.smali", "text", "constant.numeric.smali"],
      ...
      "#annotation-value_list": [{
        ...
        push: [{
          ...
          token: ["entity.name.tag.smali", "string.quoted.double.smali", "entity.name.tag.smali", "entity.name.tag.smali", "constant.numeric.smali", "entity.name.tag.smali"],
      ...
      "#directive-method-parameter": [{
        token: ["text", "support.function.smali", "text", "variable.parameter.smali", "text", "entity.name.tag.smali", "string.quoted.double.smali", "entity.name.tag.smali"],
      ...
      "#opcode-format-11n": [{
        token: ["text", "support.function.smali", "text", "variable.parameter.smali", "text", "constant.numeric.smali"],
      ...
      "#opcode-format-11x": [{
        token: ["text", "support.function.smali", "text", "variable.parameter.smali"],
      ...
      "#opcode-format-22x": [{
        token: ["text", "support.function.smali", "text", "variable.parameter.smali", "text", "variable.parameter.smali"],
      ...
      "#opcode-format-21c-type": [{
        token: ["text", "support.function.smali", "text", "variable.parameter.smali", "text", "constant.numeric.smali", "entity.name.tag.smali", "constant.numeric.smali", "entity.name.tag.smali"],
      ...
      "#opcode-format-21c-field": [{
        token: ["text", "support.function.smali", "text", "variable.parameter.smali", "text", "entity.name.tag.smali", "constant.numeric.smali", "entity.name.tag.smali", "text", "string.interpolated.smali", "text", "constant.numeric.smali", "entity.name.tag.smali", "constant.numeric.smali", "entity.name.tag.smali"],
      ...
      "#opcode-format-21t": [{
        token: ["text", "support.function.smali", "text", "variable.parameter.smali", "text", "keyword.control.smali"],
      ...
      "#opcode-format-31t": [{
        token: ["text", "support.function.smali", "text", "variable.parameter.smali", "text", "keyword.control"],
      ...
      "#opcode-format-22b": [{
        token: ["text", "support.function.smali", "text", "variable.parameter.smali", "text", "variable.parameter.smali", "text", "constant.numeric.smali"],
      ...
      "#opcode-format-22c-type": [{
        token: ["text", "support.function.smali", "text", "variable.parameter.smali", "text", "variable.parameter.smali", "text", "constant.numeric.smali", "entity.name.tag.smali", "constant.numeric.smali", "entity.name.tag.smali"],
      ...
      "#opcode-format-22c-field": [{
        token: ["text", "support.function.smali", "text", "variable.parameter.smali", "text", "variable.parameter.smali", "text", "entity.name.tag.smali", "constant.numeric.smali", "entity.name.tag.smali", "text", "string.interpolated.smali", "text", "constant.numeric.smali", "constant.numeric.smali", "constant.numeric.smali", "constant.numeric.smali", "constant.numeric.smali", "constant.numeric.smali", "constant.numeric.smali", "constant.numeric.smali", "entity.name.tag.smali", "constant.numeric.smali", "entity.name.tag.smali"],
      ...
      "#opcode-format-22t": [{
        token: ["text", "support.function.smali", "text", "variable.parameter.smali", "text", "variable.parameter.smali", "text", "keyword.control"],
      ...
      "#opcode-format-23x": [{
        token: ["text", "support.function.smali", "text", "variable.parameter.smali", "text", "variable.parameter.smali", "text", "variable.parameter.smali"],
      ...
      "#opcode-format-3rc-meth": [{
        token: ["text", "support.function.smali", "text", "variable.parameter.smali", "text", "variable.parameter.smali", "text", "entity.name.tag.smali", "constant.numeric.smali", "entity.name.tag.smali", "text", "entity.name.function.smali", "text", "constant.numeric.smali", "text", "constant.numeric.smali", "text", "constant.numeric.smali", "text", "entity.name.tag.smali", "constant.numeric.smali", "entity.name.tag.smali", "text", "constant.numeric.smali"],
      ...
      "#opcode-format-35c-type": [{
        token: ["text", "support.function.smali", "text", "variable.parameter.smali", "text", "variable.parameter.smali", "text", "variable.parameter.smali", "text", "variable.parameter.smali", "text", "variable.parameter.smali", "text", "constant.numeric.smali", "entity.name.tag.smali", "constant.numeric.smali", "entity.name.tag.smali", "text", "constant.numeric.smali"],
      ...
      "#opcode-format-35c-meth": [{
        token: ["text", "support.function.smali", "text", "variable.parameter.smali", "text", "variable.parameter.smali", "text", "variable.parameter.smali", "text", "variable.parameter.smali", "text", "variable.parameter.smali", "text", "entity.name.tag.smali", "constant.numeric.smali", "entity.name.tag.smali", "text", "entity.name.function.smali", "text", "text", "constant.numeric.smali", "text", "entity.name.tag.smali", "constant.numeric.smali", "entity.name.tag.smali", "text", "constant.numeric.smali", "text", "entity.name.tag.smali", "constant.numeric.smali", "entity.name.tag.smali", "text", "constant.numeric.smali", "text", "entity.name.tag.smali", "constant.numeric.smali", "entity.name.tag.smali", "text", "constant.numeric.smali", "text", "entity.name.tag.smali", "constant.numeric.smali", "entity.name.tag.smali", "text", "constant.numeric.smali", "text", "entity.name.tag.smali", "constant.numeric.smali", "entity.name.tag.smali", "text", "constant.numeric.smali", "text", "constant.numeric.smali", "text", "entity.name.tag.smali", "constant.numeric.smali", "entity.name.tag.smali"],
      ...
      "#opcode-format-10t-20t-30t": [{
        token: ["text", "support.function.smali", "text", "keyword.control"],
...
define("ace/mode/smali", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/smali_highlight_rules", "ace/mode/folding/cstyle"], function (require, exports, module) {
  "use strict";
